...
function connectAvatar() {
  ...
  if (privateEndpointEnabled) {
    const privateEndpointInput = document
  ...
  // Avatar config
  const talkingAvatarCharacter = document
    .getElementById("talkingAvatarCharacter")
    .value.trim();
  const talkingAvatarStyle = document
    .getElementById("talkingAvatarStyle")
    .value.trim();
  ...
  // Check Azure OpenAI
  const azureOpenAIEndpoint = document
    .getElementById("azureOpenAIEndpoint")
    .value.trim();
  const azureOpenAIApiKey = document
    .getElementById("azureOpenAIApiKey")
    .value.trim();
  const azureOpenAIDeploymentName = document
    .getElementById("azureOpenAIDeploymentName")
    .value.trim();
  if (
    !azureOpenAIEndpoint ||
    !azureOpenAIApiKey ||
  ...
  if (document.getElementById("enableOyd").checked) {
    const azureCogSearchEndpoint = document
      .getElementById("azureCogSearchEndpoint")
      .value.trim();
    const azureCogSearchApiKey = document
      .getElementById("azureCogSearchApiKey")
      .value.trim();
    const azureCogSearchIndexName = document
      .getElementById("azureCogSearchIndexName")
      .value.trim();
    if (
